...
class CompanySignupView(View):  ##RUNNING
    template_name = 'myapp/company_Register.html'
    ...
    def post(self, request):
        ...
        return render(request,'myapp/company_Register.html',{'code':code}) 
...
def home(request):   ##RUNNING
    ...
    return render(request,'myapp/home.html',{'user':user,'profile':profile_image_url})

@login_required
def meet(request):   ##RUNNING
    user =request.user
    return render(request,'myapp/WEB_UIKITS.html',{'username':user.first_name})
...
def chat_view(request):
    ...
    return render(request, 'myapp/chat.html', {'messages': messages,'c':profile.company})
...
def user_profile(request):  ##RUNNING
    ...
    return render(request, 'myapp/servay.html', {'form': form})
