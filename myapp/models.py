...
class UserProfile(models.Model):
    ...
    profile_image = models.ImageField(upload_to='myapp/static/profile_images/', null=True, blank=True)
...
class Project(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    project_file = models.FileField(upload_to='NITK_hack/myapp/uploads')
